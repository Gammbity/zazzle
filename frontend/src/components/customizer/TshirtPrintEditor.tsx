...
export default function TshirtPrintEditor({ onCanvasReady, onTextureUpdate, viewSide }: TshirtPrintEditorProps) {
    ...
    return (
        <div className="print-editor-sidebar">
            ...
            <div className="handle-legend" style={{ marginTop: '12px' }}>
                ...
                <span>Kengaytirilgan maydon: Endi dizayn yengingizgacha yetib borishi mumkin.</span>
            </div>
        </div>
    );
}
