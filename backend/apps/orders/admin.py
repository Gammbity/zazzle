...
from .models import Coupon, Order, OrderItem, Payment, ShippingMethod
...
class OrderAdmin(admin.ModelAdmin):
    ...
    list_filter = ["status", "shipping_country", "created_at", "updated_at"]
    search_fields = [
        "order_number",
        "customer__email",
        "shipping_name",
    ...
    fieldsets = (
        ...
        (
            "Tracking",
            {"fields": ("tracking_number", "carrier"), "classes": ("collapse",)},
        ),
        (
            "Timestamps",
            {
...
class OrderItemAdmin(admin.ModelAdmin):
    ...
    search_fields = ["order__order_number", "product_name", "design_title"]
...
class ShippingMethodAdmin(admin.ModelAdmin):
    ...
    list_display = ["name", "base_cost", "cost_per_item", "delivery_time", "is_active"]
...
class CouponAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("code", "name", "description", "is_active")}),
        ("Discount", {"fields": ("discount_type", "discount_value", "minimum_amount")}),
        ("Usage Limits", {"fields": ("usage_limit", "usage_count", "per_user_limit")}),
        ("Validity", {"fields": ("valid_from", "valid_to")}),
        (
            "Applicable Products",
            {"fields": ("applicable_products",), "classes": ("collapse",)},
        ),
        (
            "Timestamps",
