...
export default function ProductSurfacePreviewGrid({
  ...
  return (
    <div className='flex flex-col gap-4'>
          ...
          <button
            ...
            className={cn(
              ...
              angle.id === activeAngle.id
                ...
                : 'border border-stone-200 bg-white text-slate-600 hover:bg-amber-50 hover:border-amber-200 hover:text-amber-700'
            )}
          >
      ...
      <article className='rounded-[1.75rem] border border-stone-200 bg-white p-4 shadow-sm shadow-stone-100/50'>
        ...
        <div className='relative aspect-square overflow-hidden rounded-[1.5rem] border border-stone-200 bg-[linear-gradient(135deg,_#fffbeb_0%,_#ffffff_50%,_#fef9ee_100%)]'>
