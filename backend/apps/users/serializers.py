...
class UserSerializer(serializers.ModelSerializer):
    ...
    production_center_name = serializers.ReadOnlyField(
        source="production_center.name", default=None
    )
    production_center_slug = serializers.ReadOnlyField(
        source="production_center.slug", default=None
    )
...
class UserRegistrationSerializer(serializers.ModelSerializer):
    ...
    preferred_language = serializers.ChoiceField(
        choices=[("en", "English"), ("uz", "Uzbek"), ("ru", "Russian")], default="en"
    )
