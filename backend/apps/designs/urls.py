...
urlpatterns = [
    ...
    # Collections
    path(
        "collections/", views.DesignCollectionListView.as_view(), name="collection-list"
    ),
    path(
        "collections/<int:pk>/",
        views.DesignCollectionDetailView.as_view(),
        name="collection-detail",
    ),
    path(
        "collections/<int:collection_id>/add/<int:design_id>/",
        views.add_to_collection,
        name="add-to-collection",
    ),
    path(
        "collections/<int:collection_id>/remove/<int:design_id>/",
...
draft_urlpatterns = [
    ...
    path(
        "drafts/<uuid:uuid>/assets/",
        views.DraftAssetListView.as_view(),
        name="draft-assets",
    ),
...
rendering_urlpatterns = [
    ...
    path(
        "templates/",
        views.ProductMockupTemplateListView.as_view(),
        name="mockup-templates",
    ),
    # Draft-specific rendering
    path(
        "drafts/<uuid:uuid>/render-preview/",
        views.render_draft_preview,
        name="render-draft-preview",
    ),
    path(
        "drafts/<uuid:uuid>/renders/",
        views.draft_render_history,
        name="draft-render-history",
    ),
    path(
        "drafts/<uuid:uuid>/templates/",
        views.draft_available_templates,
        name="draft-available-templates",
    ),
