...
const ProceduralMug = ({
  ...
  const innerGeo = useMemo(
    ...
    [innerRadius, radius, height, radialSegments, heightSegments]
  );

  // Bottom inner face to seal the bottom
  const bottomGeo = useMemo(
    () => new CircleGeometry(innerRadius, radialSegments),
    [innerRadius, radialSegments]
  );
  ...
  const [canvasTexture, setCanvasTexture] = useState<Texture | null>(null);
