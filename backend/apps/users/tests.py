...
class UserModelTestCase(TestCase):
    ...
    def test_create_production_manager_user(self):
        ...
        user = User.objects.create_user(
            role=User.Role.PRODUCTION_MANAGER, **self.user_data
        )
...
class AuthenticationAPITestCase(APITestCase):
    ...
    def test_user_login(self):
        ...
        UserProfile.objects.create(
            user=user, phone_number="+998901234567", display_name="Test User"
        )
...
class ProfileAPITestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.profile = UserProfile.objects.create(
            user=self.user, phone_number="+998901234567", display_name="Test User"
        )
        self.client = APIClient()
    ...
    def test_update_user_profile(self):
        ...
        update_data = {
            "first_name": "Updated",
            "last_name": "Name",
            "profile": {"display_name": "Updated User", "preferred_language": "uz"},
        }
...
class PermissionTestCase(TestCase):
    ...
    def test_is_customer_permission(self):
        ...
        self.assertFalse(
            permission.has_permission(MockRequest(self.print_operator), None)
        )
    ...
    def test_is_owner_or_admin_permission(self):
        ...
        self.assertTrue(
            permission.has_object_permission(MockRequest(self.customer), None, obj)
        )
        ...
        self.assertFalse(
            permission.has_object_permission(MockRequest(other_customer), None, obj)
        )

        # Admin should be able to access any object
        self.assertTrue(
            permission.has_object_permission(MockRequest(self.admin), None, obj)
        )
