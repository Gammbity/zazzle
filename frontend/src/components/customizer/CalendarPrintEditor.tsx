...
export default function CalendarPrintEditor({ onCanvasReady, onTextureUpdate }: CalendarPrintEditorProps) {
        ...
        <div className="print-editor-sidebar">
            <div className="canvas-header">
                <h3 style={{ fontSize: '0.9rem', marginBottom: '8px' }}>
                    Print Hududi (Kalendar Sahifasi)
                </h3>
            </div>
            ...
            <div className="handle-legend" style={{ marginTop: '12px' }}>
                ...
                <span>Sahifa maydoni: 560x400 px</span>
            </div>
        </div>
    );
}
