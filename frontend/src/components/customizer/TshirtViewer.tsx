...
export default function TshirtViewer({ textureUrl, shirtColor, viewSide }: TshirtViewerProps) {
    ...
    const imageSrc = viewSide === 'front' ? '/products/t-shirt/front.jpg' : '/products/t-shirt/back.jpg';
    ...
    return (
        ...
        >
            ...
            <div style={{ position: 'relative', height: '90%', maxHeight: '600px', aspectRatio: '3/4' }}>
                <img
                    src={imageSrc}
