...
class DesignAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Files", {"fields": ("original_file", "optimized_file")}),
        (
            "Metadata",
            {
        ...
        ("Ownership & Type", {"fields": ("created_by", "design_type")}),
        (
            "Visibility & Pricing",
        ...
        (
            "Statistics",
            {"fields": ("download_count", "usage_count"), "classes": ("collapse",)},
        ),
        (
            "Timestamps",
...
class DraftAssetInline(admin.TabularInline):
    ...
    def file_url_display(self, obj):
        ...
        if obj.s3_key:
            return format_html(
                '<a href="{}" target="_blank">View File</a>', obj.file_url
            )
        return "No file"
...
class DraftAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Draft Information", {"fields": ("uuid", "name", "customer", "status")}),
        ("Product Details", {"fields": ("product_type", "product_variant")}),
        (
            "Design Content",
            {
        ...
        (
            "Statistics",
            {"fields": ("asset_count", "total_file_size"), "classes": ("collapse",)},
        ),
        ("Management", {"fields": ("is_deleted",)}),
        (
            "Timestamps",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
    ...
    def get_queryset(self, request):
        ...
        return (
            super()
            .get_queryset(request)
            .select_related("customer", "product_type", "product_variant")
...
class DraftAssetAdmin(admin.ModelAdmin):
    ...
    list_filter = [
        ...
        "created_at",
        "draft__status",
        "draft__product_type__category",
    ]
    search_fields = [
        "original_filename",
        "s3_key",
        "draft__name",
        "draft__customer__email",
        "uuid",
    ]
    readonly_fields = [
        "uuid",
    ...
    fieldsets = (
        ...
        ("File Details", {"fields": ("content_type", "file_size", "width", "height")}),
        ("Draft Association", {"fields": ("draft",)}),
        (
            "Editor Properties",
            {"fields": ("transform", "z_index"), "classes": ("collapse",)},
        ),
        (
            "File Access",
            {
...
class UploadSessionAdmin(admin.ModelAdmin):
    ...
    list_filter = ["is_confirmed", "content_type", "created_at", "expires_at"]
    search_fields = ["original_filename", "s3_key", "user__email", "session_id"]
    readonly_fields = ["session_id", "is_expired", "created_at", "confirmed_at"]
    ordering = ["-created_at"]

    fieldsets = (
        ("Session Information", {"fields": ("session_id", "user", "draft")}),
        (
            "Upload Details",
            {
                "fields": (
        ...
        ("Status", {"fields": ("is_confirmed", "is_expired", "expires_at")}),
        (
            "Timestamps",
            {"fields": ("created_at", "confirmed_at"), "classes": ("collapse",)},
        ),
    )
...
class ProductMockupTemplateAdmin(admin.ModelAdmin):
    ...
    list_filter = ["product_type", "product_variant", "is_active", "created_at"]
    search_fields = ["name", "product_type__name", "product_variant__name"]
    readonly_fields = ["template_preview", "template_url", "created_at", "updated_at"]
    ...
    fieldsets = (
        ...
        (
            "Template Preview",
            {"fields": ("template_preview", "template_url"), "classes": ("collapse",)},
        ),
        (
        ...
        (
            "Advanced Settings",
            {
                "fields": ("design_rotation", "design_opacity", "perspective_matrix"),
                "classes": ("collapse",),
            },
        ),
    ...
    def template_preview(self, obj):
        ...
        if obj.template_s3_key:
            ...
            if url:
                return format_html(
                    '<img src="{}" style="max-width: 200px; max-height: 150px;" />', url
                )
        return "No image"
...
class MockupRenderAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            "File Metadata",
            {
                "fields": ("output_width", "output_height", "output_file_size"),
                "classes": ("collapse",),
            },
        ),
        (
    ...
    def template_info(self, obj):
        ...
        template_url = reverse(
            "admin:designs_productmockuptemplate_change", args=[obj.mockup_template.id]
        )
        return format_html(
            '<a href="{}">{}</a>', template_url, obj.mockup_template.name
        )
    ...
    def thumbnail_preview(self, obj):
        ...
        if obj.output_thumbnail_s3_key:
            ...
            if url:
                return format_html(
                    '<img src="{}" style="max-width: 100px; max-height: 75px;" />', url
                )
        return "No thumbnail"
    ...
    def cleanup_old_renders(self, request, queryset):
        ...
        old_renders = queryset.filter(
            status__in=["completed", "failed", "cancelled"], created_at__lt=cutoff_date
        )
